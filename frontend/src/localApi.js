...
const DEFAULT_SUGGESTIONS = [
  {
    ...
    location: "Mount St. Helens, Washington", latitude: 46.1914, longitude: -122.1956, duration: "1 Tag",
    ...
    is_extension: false, added_to_trip: false,
  },
  {
    id: "s2", title: "Leavenworth - Little Bavaria",
    ...
    location: "Leavenworth, Washington", latitude: 47.5962, longitude: -120.6615, duration: "1-2 Tage",
  ...
  {
    id: "s3", title: "Yellowstone National Park",
    ...
    location: "Yellowstone National Park, Wyoming", latitude: 44.428, longitude: -110.5885, duration: "+4-5 Tage",
    ...
    is_extension: true, added_to_trip: false,
  },
  {
    id: "s4", title: "Bar J Chuckwagon",
    description: "Legendäre Cowboy-Dinner-Show auf einer echten Ranch. Deftiges Chuckwagon-Essen (BBQ, Steaks, Bohnen, Biscuits) auf Blechtellern, danach eine geniale Live-Show mit den Bar J Wranglers – echte Cowboys mit Western-Musik, Comedy und Yodeling.",
    location: "Wilson/Jackson Hole, Wyoming", latitude: 43.4799, longitude: -110.8752, duration: "1 Abend",
...
const DEFAULT_PACKING_LISTS = [
  {
    id: "pl1", title: "USA Westküste 2026 - Packliste", trip_id: "t1",
    items: [
      ...
      { id: "i5", name: "Auslandskrankenversicherung (Nachweis)", checked: false, category: "dokumente" },
      { id: "i6", name: "Buchungsbestätigungen (Hotels/KOA/Mietwagen)", checked: false, category: "dokumente" },
      { id: "i7", name: "Kopien aller Dokumente (digital + Papier)", checked: false, category: "dokumente" },
      { id: "i8", name: "Wanderschuhe (5x)", checked: false, category: "kleidung" },
      { id: "i9", name: "Regenjacken (5x)", checked: false, category: "kleidung" },
      { id: "i10", name: "Badekleidung (5x)", checked: false, category: "kleidung" },
      { id: "i11", name: "Sonnenhüte/Caps (5x)", checked: false, category: "kleidung" },
      { id: "i12", name: "Lange Hosen für Wanderungen", checked: false, category: "kleidung" },
      { id: "i13", name: "Fleece-/Softshelljacken (abends kühl)", checked: false, category: "kleidung" },
      { id: "i14", name: "Flip-Flops/Sandalen", checked: false, category: "kleidung" },
      { id: "i15", name: "Kamera + Ladegerät", checked: false, category: "elektronik" },
      { id: "i16", name: "Tablets für Autofahrten (3x)", checked: false, category: "elektronik" },
      { id: "i17", name: "Fernglas (Wildtiere!)", checked: false, category: "elektronik" },
      { id: "i18", name: "Powerbanks + USB-C Kabel", checked: false, category: "elektronik" },
      { id: "i19", name: "US-Steckdosenadapter (3x)", checked: false, category: "elektronik" },
      { id: "i20", name: "Kopfhörer für Kinder (3x)", checked: false, category: "elektronik" },
      { id: "i21", name: "Handy-Halterung fürs Auto", checked: false, category: "elektronik" },
      { id: "i22", name: "Sonnencreme LSF 50", checked: false, category: "toilettenartikel" },
      { id: "i23", name: "Reiseapotheke (Ibuprofen, Pflaster, Fieberthermometer)", checked: false, category: "toilettenartikel" },
      { id: "i24", name: "Insektenschutz", checked: false, category: "toilettenartikel" },
      { id: "i25", name: "After-Sun Lotion", checked: false, category: "toilettenartikel" },
      { id: "i26", name: "Zahnbürsten + Zahnpasta", checked: false, category: "toilettenartikel" },
      { id: "i27", name: "Junior Ranger Hefte", checked: false, category: "kinder" },
      { id: "i28", name: "Reisetagebücher (3x, für Louie/Levi/Noah)", checked: false, category: "kinder" },
      { id: "i29", name: "Buntstifte + Filzstifte", checked: false, category: "kinder" },
      { id: "i30", name: "Kuscheltiere", checked: false, category: "kinder" },
      { id: "i31", name: "Kartenspiele / Reisespiele", checked: false, category: "kinder" },
      { id: "i32", name: "Snacks für Autofahrten", checked: false, category: "essen" },
      { id: "i33", name: "Trinkflaschen (5x)", checked: false, category: "essen" },
      { id: "i34", name: "Tagesrucksack für Wanderungen", checked: false, category: "sonstiges" },
      { id: "i35", name: "Picknickdecke", checked: false, category: "sonstiges" },
      { id: "i36", name: "Taschenlampe/Stirnlampe", checked: false, category: "sonstiges" },
      { id: "i37", name: "Reise-Waschmittel", checked: false, category: "sonstiges" },
      { id: "i38", name: "Erste-Hilfe-Set fürs Auto", checked: false, category: "sonstiges" },
    ],
    created_at: "2026-01-01T00:00:00.000Z",
  },
];
